...
static std::vector<std::pair<std::string, Binding>> c335_bind() {
  return {
      {"T", Binding::column("t", "o", SqlKind::Text)},
  };
}

static std::vector<std::pair<std::string, Binding>> c336_bind() {
  return {
      {"N", Binding::column("n", "o", SqlKind::Num)},
  };
}
