...
static std::vector<std::pair<std::string, Binding>> c254_bind() {
  return {
      {"R", Binding::relation("t", "r", {{"straÃe", Binding::column("s", std::nullopt, SqlKind::Text)}}, std::nullopt, std::nullopt)},
  };
}
...
static const SqlCase CASES[] = {
    ...
    {.name = "func.text.len-counts-characters",
     ...
     .dialect = "mariadb",
     .source = "LEN(\"zaÅ¼Ã³ÅÄ\")",
     .expect = "CHAR_LENGTH('zaÅ¼Ã³ÅÄ')",
     .error = nullptr,
     .throws = nullptr,
     .params = nullptr,
     .as_ = nullptr,
    ...
    {.name = "func.regex.rfind",
     ...
     .dialect = "mariadb",
     .source = "RFIND('Ã³', \"zaÅ¼Ã³ÅÄ\")",
     .expect = "REGEXP_INSTR('zaÅ¼Ã³ÅÄ' COLLATE utf8mb4_bin, '(?s)Ã³')",
     .error = nullptr,
     .throws = nullptr,
     .params = nullptr,
     .as_ = nullptr,
    ...
    {.name = "sqlite.text.upper-needs-no-caveat",
     ...
     .dialect = "sqlite",
     .source = "UPPER(\"zaÅ¼Ã³ÅÄ\")",
     .expect = "upper('zaÅ¼Ã³ÅÄ')",
     .error = nullptr,
     .throws = nullptr,
     .params = nullptr,
     .as_ = nullptr,
