...
constexpr Entry d5_sqlite_funcs[] = {
    ...
    {.key = "TRIM", .kind = EntryKind::Template, .one = "trim({0}, ' \011\015\012')", .ret = "TEXT"},
    {.key = "LTRIM", .kind = EntryKind::Template, .one = "ltrim({0}, ' \011\015\012')", .ret = "TEXT"},
    {.key = "RTRIM", .kind = EntryKind::Template, .one = "rtrim({0}, ' \011\015\012')", .ret = "TEXT"},
...
constexpr std::string_view TEMPLATE_KEYS[] = {"identQuote", "identEscape", "textQuote", "true", "false", "numericLiteral", "textCollate", "textCharset", "textCast", "numericCast", "binaryCast", "isTrue", "isNotTrue", "placeholder"};
