...
SQL_CASES = [
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"ORDERS": Binding.relation("orders", "o", {"ID": Binding.column("id", "o", "NUM"), "CUSTOMER_ID": Binding.column("customer_id", "o", "NUM"), "AMOUNT": Binding.column("amount", "o", "NUM"), "NAME": Binding.column("name", "o", "TEXT")}, None, None), "CUSTOMERS": Binding.relation("customers", "c", {"ID": Binding.column("id", "c", "NUM"), "NAME": Binding.column("name", "c", "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": "pure_sql",
        "tables": ["customers"],
        "bindings": lambda: {"CUSTOMERS": Binding.relation("customers", "c", {"ID": Binding.column("id", "c", "NUM"), "NAME": Binding.column("name", "c", "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": "pure_sql",
        "tables": ["orders"],
        "bindings": lambda: {"ORDERS": Binding.relation("orders", "o", {"ID": Binding.column("id", "o", "NUM"), "CUSTOMER_ID": Binding.column("customer_id", "o", "NUM"), "AMOUNT": Binding.column("amount", None, "NUM"), "NAME": Binding.column("name", "o", "TEXT")}, None, None), "CUSTOMERS": Binding.relation("customers", "c", {"ID": Binding.column("id", "c", "NUM"), "NAME": Binding.column("name", "c", "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "bindings": lambda: {"ORDERS": Binding.relation("orders", "o", {"ID": Binding.column("id", "o", "NUM")}, None, None), "ITEMS": Binding.relation("order_items", "oi", {"QTY": Binding.column("qty", "oi", "NUM")}, "QTY", "`oi`.`order_id` = `o`.`id`")},
    },
    {
    ...
    },
    {
        ...
        "bindings": lambda: {"ORDERS": Binding.relation("orders", "o", {"ID": Binding.column("id", "o", "NUM")}, None, None), "FIELDS": Binding.relation("cms_fields", "g", {"FNAME": Binding.column("fname", "g", "TEXT", False, True, False)}, None, "`g`.`cmsid` = `o`.`id`", "separate")},
    },
    {
        ...
        "plan": "pure_sql",
        "tables": ["orders"],
        "bindings": lambda: {"ORDERS": Binding.relation("orders", "o", {"ID": Binding.column("id", "o", "NUM")}, None, None), "V": Binding.columns(Binding.column("a", "o", "UNKNOWN"), Binding.column("b", "o", "UNKNOWN"))},
    },
    {
        ...
        "plan": "pure_sql",
        "tables": ["orders"],
        "bindings": lambda: {"ORDERS": Binding.relation("orders", "o", {"ID": Binding.column("id", "o", "NUM")}, None, None), "R": Binding.raw("`o`.`total`", "NUM")},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"ORDERS": Binding.relation("orders", "o", {"ID": Binding.column("id", None, "NUM"), "CUSTOMER_ID": Binding.column("customer_id", None, "NUM"), "AMOUNT": Binding.column("amount", None, "NUM")}, None, None), "CUSTOMERS": Binding.relation("customers", "c", {"ID": Binding.column("id", None, "NUM"), "NAME": Binding.column("name", None, "TEXT")}, None, None)},
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"ORDERS": Binding.relation("orders", None, {"ID": Binding.column("id", None, "NUM"), "CUSTOMER_ID": Binding.column("customer_id", None, "NUM"), "AMOUNT": Binding.column("amount", None, "NUM")}, None, None), "CUSTOMERS": Binding.relation("customers", None, {"ID": Binding.column("id", None, "NUM"), "NAME": Binding.column("name", None, "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"ITEMS": Binding.relation("items", None, {"ID": Binding.column("id", None, "NUM")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"CAT": Binding.column("cat", None, "TEXT", False, True, False)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"R": Binding.relation("r", None, {"CAT": Binding.column("cat", None, "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "bindings": lambda: {"PRODUCTS": Binding.relation("products", None, {"ID": Binding.column("id", None, "NUM"), "SKU": Binding.column("sku", None, "TEXT"), "CATEGORY_ID": Binding.column("category_id", None, "NUM"), "IS_ACTIVE": Binding.column("is_active", None, "NUM")}, None, None), "ORDER_ITEMS": Binding.relation("order_items", None, {"ID": Binding.column("id", None, "NUM"), "PRODUCT_ID": Binding.column("product_id", None, "NUM")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"R": Binding.relation("r", None, {"ID": Binding.column("id", None, "NUM"), "FK": Binding.column("fk", None, "NUM"), "CAT": Binding.column("cat", None, "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": "hybrid",
        "tables": ["r"],
        "bindings": lambda: {"R": Binding.relation("r", None, {"ID": Binding.column("id", None, "NUM"), "FK": Binding.column("fk", None, "TEXT")}, None, None).with_unique_key("id")},
    },
    {
    ...
    },
    {
        ...
        "plan": "pure_memory",
        "tables": ["r"],
        "bindings": lambda: {"R": Binding.relation("r", None, {"ID": Binding.column("id", None, "NUM"), "FK": Binding.column("fk", None, "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"R": Binding.relation("r", None, {"V": Binding.column("v", None, "NUM")}, None, None)},
    },
    {
        ...
        "plan": "hybrid",
        "tables": ["r"],
        "bindings": lambda: {"R": Binding.relation("r", None, {"CAT": Binding.column("cat", None, "UNKNOWN")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": "hybrid",
        "tables": ["r"],
        "bindings": lambda: {"R": Binding.relation("r", None, {"V": Binding.column("v", None, "NUM", False, False, True)}, None, None)},
    },
    {
        ...
        "plan": "hybrid",
        "tables": ["r"],
        "bindings": lambda: {"R": Binding.relation("r", None, {"V": Binding.raw("v", "NUM")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"N": Binding.column("n", "r", "NUM"), "T": Binding.column("t", "r", "TEXT")},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"R": Binding.relation("r", None, {"N": Binding.column("n", None, "NUM"), "T": Binding.column("t", None, "TEXT")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": "pure_sql",
        "tables": ["products", "order_items"],
        "bindings": lambda: {"PRODUCTS": Binding.relation("products", None, {"ID": Binding.column("id", None, "NUM"), "CATEGORY_ID": Binding.column("category_id", None, "NUM"), "IS_ACTIVE": Binding.column("is_active", None, "NUM")}, None, None), "ORDER_ITEMS": Binding.relation("order_items", None, {"ID": Binding.column("id", None, "NUM"), "PRODUCT_ID": Binding.column("product_id", None, "NUM")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"R": Binding.relation("r", None, {"N": Binding.column("n", None, "NUM"), "U": Binding.column("u", None, "UNKNOWN")}, None, None)},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"T": Binding.column("title", "t", "TEXT")},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"PRICE": Binding.column("price", "p", "NUM"), "COST": Binding.column("cost", "p", "UNKNOWN")},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"TAGS": Binding.columns(Binding.column("tag1", "o", "TEXT"), Binding.column("tag2", "o", "TEXT"), Binding.column("tag3", "o", "TEXT"))},
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"TAG": Binding.column("tag", "t", "TEXT")},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"ALLOWED": Binding.value(value_tree([Value.text("x"), Value.text("y")]), None), "TAG": Binding.column("tag", "t", "TEXT")},
    },
    {
    ...
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"ITEMS": Binding.relation("items", "i", {"sku": Binding.column("sku", "i", "TEXT")}, "sku", None)},
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"NONE_ALLOWED": Binding.value(value_tree([]), None)},
    },
    {
        ...
        "plan": None,
        "tables": None,
        "bindings": lambda: {"NESTED": Binding.value(value_tree([value_tree([Value.text("a")]), Value.text("b")]), None)},
    },
    {
    ...
    },
    {
        ...
        "plan": "pure_sql",
        "tables": ["articles"],
        "bindings": lambda: {"ARTICLES": Binding.relation("articles", "a", {"id": Binding.column("id", "a", "NUM"), "title": Binding.column("title", "a", "TEXT")}, None, None)},
    },
    {
