...
Every joined row is built from its own pair of elements (2026-09-23; WL-001 SEL-0053).
  ...
  - **Cost, against the same tree with the pre-SEL-0053 row builders, interleaved, seven runs:** S1 C++ +1.1%, JS +2.5%, PHP +3.5%, Python +2.9%, Lisp 0; S6 C++ +0.4%, JS +1.5%, PHP +0.9%, **Python +4.8%**, Lisp −2.8%; S2–S4 within spread; S5 faster on every host (C++ −13%, JS −6%, PHP −30%, Lisp −16%, Python −1%) now that the retired gates no longer hold the pre-filter back.
