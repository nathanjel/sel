...
function sql_cases(): array
{
    return [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['B' => Binding::value(Value::bin(hex2bin('00ff')), null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM'), 'AMOUNT' => Binding::column('amount', 'o', 'NUM'), 'NAME' => Binding::column('name', 'o', 'TEXT')], null, null), 'CUSTOMERS' => Binding::relation('customers', 'c', ['ID' => Binding::column('id', 'c', 'NUM'), 'NAME' => Binding::column('name', 'c', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['B' => Binding::column('b', 'o', 'BIN')],
        ],
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['dialect' => 'norel', 'extends' => 'mariadb', 'version' => '10.5'], ['define' => ['norel', 'skel', 'inRelation', null]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('t', 'oi', ['sku' => Binding::column('sku', 'oi', 'TEXT')], 'sku', 'oi.o = o.id')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['R' => Binding::relation('t', 'r', ['straße' => Binding::column('s', null, 'TEXT')], null, null)],
        ],
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['dialect' => 'scratch', 'extends' => null, 'version' => '1', 'target' => true, 'lexical' => ['identQuote' => '"', 'identEscape' => '""', 'textQuote' => '\'', 'textEscape' => ['\'' => '\'\''], 'true' => 'TRUE', 'false' => 'FALSE', 'numericLiteral' => '{0}', 'placeholder' => '?']], ['define' => ['scratch', 'ops', '+', ['tpl' => '({0} + {1})', 'ret' => 'NUM']]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('t', null, 'NUM'), 'S' => Binding::value(Value::text('abc'), null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['COLS' => Binding::columns(Binding::column('c1', null, 'UNKNOWN'), Binding::column('c2', null, 'UNKNOWN'), Binding::column('c3', null, 'UNKNOWN'), Binding::column('c4', null, 'UNKNOWN'), Binding::column('c5', null, 'UNKNOWN'), Binding::column('c6', null, 'UNKNOWN'), Binding::column('c7', null, 'UNKNOWN'), Binding::column('c8', null, 'UNKNOWN'), Binding::column('c9', null, 'UNKNOWN'), Binding::column('c10', null, 'UNKNOWN'), Binding::column('c11', null, 'UNKNOWN'), Binding::column('c12', null, 'UNKNOWN'), Binding::column('c13', null, 'UNKNOWN'))],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['V' => Binding::columns(Binding::column('a', null, 'UNKNOWN'), Binding::column('b', null, 'UNKNOWN')), 'U' => Binding::column('u', null, 'UNKNOWN')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('oi', 'oi', ['QTY' => Binding::column('qty', 'oi', 'TEXT')], null, '`oi`.`o`=`o`.`id`')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('oi', 'oi', ['QTY' => Binding::column('qty', 'oi', 'UNKNOWN')], null, '`oi`.`o`=`o`.`id`')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::raw('nv.value', 'UNKNOWN')],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::raw('nv.value', 'NUM')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['QTY' => Binding::column('qty', null, 'NUM')],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['A' => Binding::column('a', null, 'NUM'), 'B' => Binding::column('b', null, 'NUM')],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['CODE' => Binding::column('code', null, 'TEXT')],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['DISCOUNT' => Binding::column('discount', null, 'NUM')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['POSTCODE' => Binding::column('postcode', null, 'TEXT')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['TYPEPATH' => Binding::column('typepath', 'cms_entry', 'TEXT', true, false, false)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['A' => Binding::column('a', null, 'TEXT', true, false, false), 'B' => Binding::column('b', null, 'TEXT', true, false, false)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['A' => Binding::column('a', null, 'TEXT', true, false, false)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['TYPEPATH' => Binding::column('typepath', 'cms_entry', 'TEXT', false, true, false)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['STATUS' => Binding::column('status', null, 'TEXT', true, false, false)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['VAL' => Binding::column('val', null, 'NUM', false, false, true)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['FIELDS' => Binding::relation('cms_fields', 'g', ['fname' => Binding::column('fname', 'g', 'TEXT', true, false, false), 'value' => Binding::column('value', 'g', 'TEXT', false, true, false)], null, '`g`.`cmsid` = `cms_entry`.`cmsid`', 'separate')],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['FIELDS' => Binding::relation('cms_fields', 'g', ['fname' => Binding::column('fname', 'g', 'TEXT', true, false, false), 'value' => Binding::column('value', 'g', 'TEXT', false, true, false, null, 'separate')], null, '`g`.`cmsid` = `cms_entry`.`cmsid`')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['FIELDS' => Binding::relation('cms_fields', 'g', ['fname' => Binding::column('fname', 'g', 'TEXT', true, false, false), 'value' => Binding::column('value', 'g', 'TEXT', false, true, false, null, 'separate')], null, '`g`.`cmsid` = `cms_entry`.`cmsid`', 'inline')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, [], null, null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', 'i', [], null, null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['ID' => Binding::column('id', null, 'UNKNOWN')], null, null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['ID' => Binding::column('id', null, 'UNKNOWN'), 'TOTAL' => Binding::column('total', null, 'UNKNOWN')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', 'i', ['ID' => Binding::column('id', null, 'UNKNOWN'), 'TOTAL' => Binding::column('total', null, 'UNKNOWN')], null, null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['TOTAL' => Binding::column('total', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['ID' => Binding::column('id', null, 'NUM'), 'TOTAL' => Binding::column('total', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['ID' => Binding::column('id', null, 'UNKNOWN'), 'TOTAL' => Binding::column('total', null, 'NUM')], null, null)],
        ],
        [
            'name' => 'stmt.distinct',
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', 'i', ['TOTAL' => Binding::column('total', 'i', 'NUM')], null, 'i.order_id = o.id')],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['TOTAL' => Binding::column('total', null, 'NUM'), 'NAME' => Binding::column('name', null, 'TEXT', true, false, false)], null, null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['NAME' => Binding::column('name', null, 'TEXT', true, false, false)], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['QTY' => Binding::column('qty', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT'), 'AMOUNT' => Binding::column('amount', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'NAME' => Binding::column('name', 'o', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT')], null, null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT'), 'CATEGORY' => Binding::column('category', null, 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT'), 'AMOUNT' => Binding::column('amount', null, 'NUM'), 'ACTIVE' => Binding::column('active', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT'), 'CATEGORY' => Binding::column('category', null, 'TEXT'), 'ACTIVE' => Binding::column('active', null, 'BOOL'), 'QTY' => Binding::column('qty', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT'), 'QTY' => Binding::column('qty', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT', true, false, false)], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['DEPT' => Binding::column('dept', null, 'TEXT'), 'STATUS' => Binding::column('status', null, 'TEXT')], null, null)],
        ],
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null), 'LIMIT' => Binding::value(Value::text('5'), 'NUM')],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['sales_orders'],
            'bindings' => static fn (): array => ['SALES' => Binding::relation('sales_orders', 's', ['ID' => Binding::column('id', 's', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM')], null, null), 'CUSTOMERS' => Binding::relation('customers', 'c', ['ID' => Binding::column('id', 'c', 'NUM')], null, null)],
        ],
        [
            ...
            'plan' => 'pure_memory',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null), 'O2' => Binding::relation('orders', 'o2', ['ID' => Binding::column('id', 'o2', 'NUM')], null, null)],
        ],
        [
            ...
            'bindings' => static fn (): array => ['RECENT' => Binding::relationQuery('(SELECT * FROM orders WHERE id > 10)', 'r', ['ID' => Binding::column('id', 'r', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['NAME' => Binding::column('name', 'o', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_memory',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM'), 'AMOUNT' => Binding::column('amount', 'o', 'NUM'), 'NAME' => Binding::column('name', 'o', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'hybrid',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'NAMé' => Binding::column('name', 'o', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_memory',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ACTIVE' => Binding::column('active', 'o', 'BOOL')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'hybrid',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM'), 'AMOUNT' => Binding::column('amount', 'o', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['AMOUNT' => Binding::column('amount', 'o', 'NUM')], null, null)],
        ],
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'AMOUNT' => Binding::column('amount', 'o', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_memory',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM'), 'AMOUNT' => Binding::column('amount', 'o', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_memory',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM'), 'STATUS' => Binding::column('status', 'o', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'hybrid',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null), 'USERS' => Binding::relation('users', 'u', ['ID' => Binding::column('id', 'u', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['customers'],
            'bindings' => static fn (): array => ['CUSTOMERS' => Binding::relation('customers', 'c', ['ID' => Binding::column('id', 'c', 'NUM'), 'NAME' => Binding::column('name', 'c', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', 'o', 'NUM'), 'AMOUNT' => Binding::column('amount', null, 'NUM'), 'NAME' => Binding::column('name', 'o', 'TEXT')], null, null), 'CUSTOMERS' => Binding::relation('customers', 'c', ['ID' => Binding::column('id', 'c', 'NUM'), 'NAME' => Binding::column('name', 'c', 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null), 'ITEMS' => Binding::relation('order_items', 'oi', ['QTY' => Binding::column('qty', 'oi', 'NUM')], 'QTY', '`oi`.`order_id` = `o`.`id`')],
        ],
        [
        ...
        [
            ...
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null), 'FIELDS' => Binding::relation('cms_fields', 'g', ['FNAME' => Binding::column('fname', 'g', 'TEXT', false, true, false)], null, '`g`.`cmsid` = `o`.`id`', 'separate')],
        ],
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null), 'V' => Binding::columns(Binding::column('a', 'o', 'UNKNOWN'), Binding::column('b', 'o', 'UNKNOWN'))],
        ],
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['orders'],
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', 'o', 'NUM')], null, null), 'R' => Binding::raw('`o`.`total`', 'NUM')],
        ],
        [
...
ORDERS .> TAKE(1)',
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', 'o', ['ID' => Binding::column('id', null, 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', null, 'NUM'), 'AMOUNT' => Binding::column('amount', null, 'NUM')], null, null), 'CUSTOMERS' => Binding::relation('customers', 'c', ['ID' => Binding::column('id', null, 'NUM'), 'NAME' => Binding::column('name', null, 'TEXT')], null, null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ORDERS' => Binding::relation('orders', null, ['ID' => Binding::column('id', null, 'NUM'), 'CUSTOMER_ID' => Binding::column('customer_id', null, 'NUM'), 'AMOUNT' => Binding::column('amount', null, 'NUM')], null, null), 'CUSTOMERS' => Binding::relation('customers', null, ['ID' => Binding::column('id', null, 'NUM'), 'NAME' => Binding::column('name', null, 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', null, ['ID' => Binding::column('id', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['CAT' => Binding::column('cat', null, 'TEXT', false, true, false)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['CAT' => Binding::column('cat', null, 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'bindings' => static fn (): array => ['PRODUCTS' => Binding::relation('products', null, ['ID' => Binding::column('id', null, 'NUM'), 'SKU' => Binding::column('sku', null, 'TEXT'), 'CATEGORY_ID' => Binding::column('category_id', null, 'NUM'), 'IS_ACTIVE' => Binding::column('is_active', null, 'NUM')], null, null), 'ORDER_ITEMS' => Binding::relation('order_items', null, ['ID' => Binding::column('id', null, 'NUM'), 'PRODUCT_ID' => Binding::column('product_id', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['ID' => Binding::column('id', null, 'NUM'), 'FK' => Binding::column('fk', null, 'NUM'), 'CAT' => Binding::column('cat', null, 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'hybrid',
            'tables' => ['r'],
            'bindings' => static fn (): array => ['R' => (Binding::relation('r', null, ['ID' => Binding::column('id', null, 'NUM'), 'FK' => Binding::column('fk', null, 'TEXT')], null, null))->withUniqueKey('id')],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_memory',
            'tables' => ['r'],
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['ID' => Binding::column('id', null, 'NUM'), 'FK' => Binding::column('fk', null, 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['V' => Binding::column('v', null, 'NUM')], null, null)],
        ],
        [
            ...
            'plan' => 'hybrid',
            'tables' => ['r'],
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['CAT' => Binding::column('cat', null, 'UNKNOWN')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'hybrid',
            'tables' => ['r'],
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['V' => Binding::column('v', null, 'NUM', false, false, true)], null, null)],
        ],
        [
            ...
            'plan' => 'hybrid',
            'tables' => ['r'],
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['V' => Binding::raw('v', 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['N' => Binding::column('n', 'r', 'NUM'), 'T' => Binding::column('t', 'r', 'TEXT')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['N' => Binding::column('n', null, 'NUM'), 'T' => Binding::column('t', null, 'TEXT')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['products', 'order_items'],
            'bindings' => static fn (): array => ['PRODUCTS' => Binding::relation('products', null, ['ID' => Binding::column('id', null, 'NUM'), 'CATEGORY_ID' => Binding::column('category_id', null, 'NUM'), 'IS_ACTIVE' => Binding::column('is_active', null, 'NUM')], null, null), 'ORDER_ITEMS' => Binding::relation('order_items', null, ['ID' => Binding::column('id', null, 'NUM'), 'PRODUCT_ID' => Binding::column('product_id', null, 'NUM')], null, null)],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['R' => Binding::relation('r', null, ['N' => Binding::column('n', null, 'NUM'), 'U' => Binding::column('u', null, 'UNKNOWN')], null, null)],
        ],
        [
        ...
        [
            ...
            'as' => 'condition',
            'mode' => null,
            'register' => [['function' => ['SLUG', 1, 1]], ['define' => ['postgresql', 'funcs', 'SLUG', ['tpl' => 'slug({0})', 'ret' => 'TEXT', 'args' => ['TEXT']]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('title', 't', 'TEXT')],
        ],
        [
        ...
        [
            ...
            'as' => 'condition',
            'mode' => 'params',
            'register' => [['function' => ['SLUG', 1, 1]], ['define' => ['postgresql', 'funcs', 'SLUG', ['tpl' => 'slug({0})', 'ret' => 'TEXT', 'args' => ['TEXT']]]], ['dialect' => 'pg-numbered', 'extends' => 'postgresql', 'version' => '15', 'target' => true, 'lexical' => ['placeholder' => '${n}']]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('title', 't', 'TEXT')],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['UNSPELLED', 1, 1]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('title', 't', 'TEXT')],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['MARGIN_PCT', 2, 3]], ['define' => ['postgresql', 'funcs', 'MARGIN_PCT', ['tpl' => ['2' => 'margin_pct({0}, {1})', '3' => 'round(margin_pct({0}, {1}), {2})'], 'ret' => 'NUM', 'args' => ['NUM', 'NUM', 'NUM']]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['PRICE' => Binding::column('price', 'p', 'NUM'), 'COST' => Binding::column('cost', 'p', 'UNKNOWN')],
        ],
        [
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['ARITY_ONE', 1, 1]], ['define' => ['postgresql', 'funcs', 'ARITY_ONE', ['tpl' => ['2' => 'f({0}, {1})'], 'ret' => 'TEXT']]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['ARITY_TWO', 1, 2]], ['define' => ['postgresql', 'funcs', 'ARITY_TWO', ['tpl' => 'f({*})', 'ret' => 'TEXT', 'arity' => [1, 3]]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['ARITY_TWO', 1, 2]], ['define' => ['postgresql', 'funcs', 'ARITY_TWO', ['tpl' => 'f({*})', 'ret' => 'TEXT', 'arity' => [1, 1]]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('title', 't', 'TEXT')],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['REREG', 1, 1]], ['define' => ['postgresql', 'funcs', 'REREG', ['tpl' => 'rereg({0})', 'ret' => 'TEXT']]], ['function' => ['REREG', 1, 2]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('title', 't', 'TEXT')],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['REREG_SAME', 1, 1]], ['define' => ['postgresql', 'funcs', 'REREG_SAME', ['tpl' => 'rereg({0})', 'ret' => 'TEXT']]], ['function' => ['REREG_SAME', 1, 1]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('title', 't', 'TEXT')],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['define' => ['postgresql', 'funcs', 'NEVER_REGISTERED_FN', ['tpl' => 'f({0})', 'ret' => 'TEXT']]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['define' => ['postgresql', 'funcs', 'UPPER', ['tpl' => 'UPPER({0})', 'ret' => 'TEXT', 'args' => ['TEXT']]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['KIND_BAD', 1, 1]], ['define' => ['postgresql', 'funcs', 'KIND_BAD', ['tpl' => 'f({0})', 'ret' => 'TEXT', 'args' => ['DATE']]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['ARGS_LONG', 1, 1]], ['define' => ['postgresql', 'funcs', 'ARGS_LONG', ['tpl' => 'f({0})', 'ret' => 'TEXT', 'args' => ['TEXT', 'TEXT']]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['RET_LIST', 1, 1]], ['define' => ['postgresql', 'funcs', 'RET_LIST', ['tpl' => 'f({0})', 'ret' => 'LIST']]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['FLAG_TEXT', 1, 1]], ['define' => ['postgresql', 'funcs', 'FLAG_TEXT', ['tpl' => 'flag_text({0})', 'ret' => 'TEXT']]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => [],
        ...
        [
            ...
            'as' => null,
            'mode' => null,
            'register' => [['function' => ['IS_OPEN', 1, 1]], ['define' => ['postgresql', 'funcs', 'IS_OPEN', ['tpl' => 'is_open({0})', 'ret' => 'BOOL', 'args' => ['BOOL']]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['T' => Binding::column('title', 't', 'TEXT')],
        ...
        [
            ...
            'as' => 'condition',
            'mode' => null,
            'register' => [['function' => ['HAS_TAG', 2, 2]], ['define' => ['postgresql', 'funcs', 'HAS_TAG', ['tpl' => '({1} = ANY(ARRAY[{0}]))', 'ret' => 'BOOL', 'args' => ['LIST', 'TEXT']]]]],
            'options' => null,
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['TAGS' => Binding::columns(Binding::column('tag1', 'o', 'TEXT'), Binding::column('tag2', 'o', 'TEXT'), Binding::column('tag3', 'o', 'TEXT'))],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['TAG' => Binding::column('tag', 't', 'TEXT')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ALLOWED' => Binding::value(sel_value_tree([Value::text('x'), Value::text('y')]), null), 'TAG' => Binding::column('tag', 't', 'TEXT')],
        ],
        [
        ...
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['ITEMS' => Binding::relation('items', 'i', ['sku' => Binding::column('sku', 'i', 'TEXT')], 'sku', null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['NONE_ALLOWED' => Binding::value(sel_value_tree([]), null)],
        ],
        [
            ...
            'plan' => null,
            'tables' => null,
            'bindings' => static fn (): array => ['NESTED' => Binding::value(sel_value_tree([sel_value_tree([Value::text('a')]), Value::text('b')]), null)],
        ],
        [
        ...
        [
            ...
            'plan' => 'pure_sql',
            'tables' => ['articles'],
            'bindings' => static fn (): array => ['ARTICLES' => Binding::relation('articles', 'a', ['id' => Binding::column('id', 'a', 'NUM'), 'title' => Binding::column('title', 'a', 'TEXT')], null, null)],
        ],
        [
