...
tools/check-version.sh 0.4.0                      # every manifest agrees
```
...
cpp/conanfile.py                 version = "0.4.0"
cpp/vcpkg.json                   "version-semver": "0.4.0"
cpp/CMakeLists.txt               project(... VERSION 0.4.0 ...)
lisp/sel-lang.asd                :version "0.4.0"
```
...
```
conan upload sel-lang/0.4.0 -r <remote> --confirm
```
