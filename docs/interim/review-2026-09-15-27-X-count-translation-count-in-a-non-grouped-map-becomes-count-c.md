...
**Status:** FIXED 2026-09-15 — see CHANGELOG "[Unreleased]" › "The bucket body's scope is the evaluator's" (first facet with J/K; second facet, the scalar fallback, in the same entry).
